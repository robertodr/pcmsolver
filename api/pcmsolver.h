 ...
 */
PCMSOLVER_API void pcmsolver_initialize_propagation(
    pcmsolver_context_t * context, const char * mep_0, const char * asc_0,
    const char * mep_t, const char * asc_t, const char * mep_tdt,
    const char * asc_tdt, int irrep);
