...
SCENARIO("Calculation of the dipolar potential", "[utils][dipolar_potential][utils_dipolar-potential]")
{
  GIVEN("A classical charge distribution of dipoles")
  {
    ...
    AND_WHEN("the dipolar potential is calculated in an ionic liquid with kappa = 0.0")
    {
      double permittivity = 78.39;
      double kappa = 0.0;
