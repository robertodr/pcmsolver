...
SCENARIO("Test variational solver for the IEFPCM for a point charge and a GePol cavity", "[variational_solver][viefpcm][viefpcm_gepol-point]")
{
    GIVEN("An isotropic environment and a point charge")
    {
        ...
        /*! \class VIEFSolver
         *  \test \b pointChargeGePol tests VIEFSolver using a point charge with a GePol cavity
        ...
        /*! \class VIEFSolver
         *  \test \b pointChargeShiftedGePol tests VIEFSolver using a point charge with a GePol cavity
