...
/*! \class VIEFSolver
 *  \test \b pointChargeGePolRestart tests VIEFSolver using a point charge with a GePol cavity read from .npz file
 */
TEST_CASE("Test variational solver for the IEFPCM for a point charge and a restarted GePol cavity", "[variational_solver][viefpcm][viefpcm_gepol-point_from-file]")
{
    // Load cavity
    GePolCavity cavity;
