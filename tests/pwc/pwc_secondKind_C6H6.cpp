...
/*! \class PWLSolver
 *  \test \b  C6H6 tests PWLSolver with the second kind equation using benzene and a wavelet cavity
 */
TEST_CASE("Piecewise constant wavelet solver for a benzene molecule and second kind equation", "[solver][pwc][pwc_secondKind_C6H6]")
{
    LOG_INIT();
    ...
    fake_En = solver.computeCharge(fake_asc);
