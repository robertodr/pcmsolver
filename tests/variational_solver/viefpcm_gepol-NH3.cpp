...
/*! \class VIEFSolver
 *  \test \b NH3GePol tests VIEFSolver using ammonia and a GePol cavity
 */
TEST_CASE("Test variational solver for the IEFPCM with NH3 molecule and a GePol cavity", "[variational_solver][viefpcm][viefpcm_gepol-NH3]")
{
    Molecule molec = NH3();
