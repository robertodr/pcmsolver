...
SCENARIO("Test variational solver for the IEFPCM for a point charge in a spherical diffuse environment and a GePol cavity", "[variational_solver][viefpcm][viefpcm_diffuse-gepol-point][anisotropic]")
{
    GIVEN("An isotropic environment modelled as a spherical diffuse permittivity")
    {
        ...
        /*! \class VIEFSolver
         *  \test \b pointChargeDiffuseGePol tests VIEFSolver using a point charge with a GePol cavity and a spherical diffuse interface
