...
/*! \class VIEFSolver
 *  \test \b NH3GePolRestart tests VIEFSolver using ammonia with a GePol cavity read from .npz file
 */
TEST_CASE("Test variational solver for the IEFPCM for NH3 and a restarted GePol cavity", "[variational_solver][viefpcm][viefpcm_gepol-NH3_from-file]")
{
