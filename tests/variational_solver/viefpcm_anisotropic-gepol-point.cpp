...
SCENARIO("Test variational solver for the anisotropic IEFPCM for a point charge and a GePol cavity", "[variational_solver][viefpcm][viefpcm_anisotropic-gepol-point][anisotropic]")
{
    GIVEN("An isotropic environment modelled and a point charge forcing the use of an anisotropic solver")
    {
        ...
        /*! \class VIEFSolver
         *  \test \b anisotropicPointChargeGePol tests VIEFSolver using a point charge with a GePol cavity
        ...
        /*! \class VIEFSolver
         *  \test \b anisotropicPointChargeShiftedGePol tests VIEFSolver using a point charge with a GePol cavity
         *  We are forcing the usage of the buildAnisotropicMatrix method.
         *  The results are compared with Gauss' theorem and the results from the buildIsotropicMatrix method
