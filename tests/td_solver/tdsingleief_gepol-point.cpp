 ...
 * GePol cavity
 */
TEST_CASE("Test solver for the time-dependent IEFPCM with a single relaxation time, "
          "a point dipole and a GePol cavity",
          "[td_solver][tdief][tdsingleief_gepol-point]") {
  // Set up cavity
