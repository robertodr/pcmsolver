...
void save_tdief_lowdin_collocation(const GePolCavity &, const IGreensFunction &,
                                   const BoundaryIntegralOperator &, double, double,
                                   double, double, double);
void save_tdcpcm_collocation(const GePolCavity &, const IGreensFunction &,
                             const BoundaryIntegralOperator &, double, double,
                             double, double, double);
void save_tdsingleief_collocation(const GePolCavity &, const IGreensFunction &,
                                  const BoundaryIntegralOperator &, double, double,
                                  double, double, double);
void save_tdonsagerief_collocation(const GePolCavity &, const IGreensFunction &,
                                   const BoundaryIntegralOperator &, double, double,
                                   double, double, double);
...
int main() {
  ...
  save_tdief_lowdin_collocation(cavity, gfInside, biop, e_0, e_d, tau, dt,
                                total_time);
  save_tdcpcm_collocation(cavity, gfInside, biop, e_0, e_d, tau, dt, total_time);
  save_tdsingleief_collocation(cavity, gfInside, biop, e_0, e_d, tau, dt,
                               total_time);
  save_tdonsagerief_collocation(cavity, gfInside, biop, e_0, e_d, tau, dt,
                                total_time);
...
void save_tdief_lowdin_collocation(const GePolCavity & cavity,
  ...
  cnpy::npy_save("tdief_lowdin_collocation.npy", TDIEF.data(), new_shape, 1, "w",
                 true);
}
