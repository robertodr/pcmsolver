...
public:
   ...
   * formalisms.
   */
  double propagateASC(const char * mep_t, const char * asc_t, const char * mep_tdt,
                      const char * asc_tdt, double dt, int irrep) const;
...
private:
   ...
   *  \return the polarization energy at time t+dt
   */
  double delayedASC(const char * mep_t, const char * asc_t, const char * mep_tdt,
                    const char * asc_tdt, double dt, int irrep) const;
};
} /* end namespace pcm */
