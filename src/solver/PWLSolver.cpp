...
void PWLSolver::buildSystemMatrix_impl(const Cavity & cavity, const IGreensFunction & gf_i, const IGreensFunction & gf_o)
{
...
void PWLSolver::constructSystemMatrix(const IGreensFunction & gf_i, const IGreensFunction & gf_o)
{
    constructSi(gf_i);
...
void PWLSolver::constructSi(const IGreensFunction & gf_i){
    double factor = 0.0;
...
void PWLSolver::constructSe(const IGreensFunction & gf_o){
...
Eigen::VectorXd PWLSolver::computeCharge_impl(const Eigen::VectorXd & potential,
                           int /* irrep */)
{
