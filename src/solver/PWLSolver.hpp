...
public:
    PWLSolver(const Compression & _comp, int integralEquation_ = SecondKind)
        : PCMSolver(), interpolationGrade(3), interpolationType(1),
...
protected:
    ...
    void solveFirstKind(const Eigen::VectorXd & potential,
                        Eigen::VectorXd & charge);
    void solveSecondKind(const Eigen::VectorXd & potential,
                         Eigen::VectorXd & charge);
    void solveFull(const Eigen::VectorXd & potential,
                   Eigen::VectorXd & charge);
