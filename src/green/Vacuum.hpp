...
private:
  ...
  virtual KernelS exportKernelS_impl() const __override {
    return pcm::bind(&Vacuum<DerivativeTraits, IntegratorPolicy>::kernelS, *this,
                     pcm::_1, pcm::_2);
  }
  virtual KernelD exportKernelD_impl() const __override {
    return pcm::bind(&Vacuum<DerivativeTraits, IntegratorPolicy>::kernelD, *this,
                     pcm::_1, pcm::_2, pcm::_3);
  }
